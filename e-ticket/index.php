...
<title>Welcome to Online Ticket Booking System</title>
...
<div id="wrapper">
	<div id="header">
    <h1><a href="index.php"><img src="xres/images/logo.png" style="left: 200px;" class="logo" alt="Welcome to Online Ticket Booking System" /></a></h1>
        <ul id="mainnav">
    ...
    <div id="featured">
        <div id="items">
            ...
            <p><a href="lodging.php"><strong>From Chittagong to Dhaka Vice versa</strong><br />
			Spend a relaxing evening in our Radisson Blu. </a></p>  
			</div>
