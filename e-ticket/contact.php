    	...
    	<div id="gallerycontainer">
			<div class="portfolio-area" style="margin:0 auto; padding:140px 20px 20px 20px; width:820px;">	
				<div id="contactleft">
					GREENLINE BUS<br>
SAYEDABAD, DHAKA<br>
Phone:  +88XXXXXXXXX<br><br>

GREENLINE BUS<br>
DAMPARA, CHITTAGONG<br>
Telephone No: (XXX) XXX-XXXX<br><br>


GREENLINE Bus Terminal in DHAKA City by G.V. GREENLINE Transport, Inc.<br>
Location: SAYEDABAD Link Road, DHAKA<br><br>

Contact Numbers:<br>
GREENLINE Bus Company Chittagong<br>
-  +XX XXXXXXXXXX<br>
				</div><br>
				<div id="contactright">
					<h3>Message Form</h3>
